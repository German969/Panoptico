function agregar() {
	...
	+ '<tr id="p' + tt 
	+ '"><th id="f' + tt 
	+ 'c1" scope="row">' + tt 	+ '</th><td id="f' + tt 	+ 'c2">?</td><td id="f' + tt 	+ 'c3">?</td><td><input type="button" class="btn btn-primary" value="Eliminar" onclick="borrar(document.getElementById(\'p' + tt 	+ '\'))"></td><td id="M' + tt + '"><input type="button" class="btn btn-primary" value="Modificar" onclick="modp(' + tt + ')"></td></tr>';
